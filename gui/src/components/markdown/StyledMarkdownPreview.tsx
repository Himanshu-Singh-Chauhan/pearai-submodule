...
const FadeInElement: React.FC<FadeInWordsProps> = (props: FadeInWordsProps) => {
  ...
  const [reactContent, setMarkdownSource] = useRemark({
    ...
    rehypeReactOptions: {
      components: {
        ...
        h1: ({ node, ...hProps }) => {
          if (props.isLast) {
            return <FadeInElement as="h1" {...hProps} {...props}>{hProps.children}</FadeInElement>;
          }
          return <h1 {...hProps}>{hProps.children}</h1>;
        },
        h2: ({ node, ...hProps }) => {
          if (props.isLast) {
            return <FadeInElement as="h2" {...hProps} {...props}>{hProps.children}</FadeInElement>;
          }
          return <h2 {...hProps}>{hProps.children}</h2>;
        },
        h3: ({ node, ...hProps }) => {
          if (props.isLast) {
            return <FadeInElement as="h3" {...hProps} {...props}>{hProps.children}</FadeInElement>;
          }
          return <h3 {...hProps}>{hProps.children}</h3>;
        },
        h4: ({ node, ...hProps }) => {
          if (props.isLast) {
            return <FadeInElement as="h4" {...hProps} {...props}>{hProps.children}</FadeInElement>;
          }
        ...
        p: ({ node, ...pProps }) => {
          ...
          if (props.isLast) {
            return <FadeInElement as="p" {...pProps} {...props}>{pProps.children}</FadeInElement>;
          }
          return <p {...pProps}>{pProps.children}</p>;
        },
        li: ({ node, ...liProps }) => {
          if (props.isLast) {
            return <FadeInElement as="li" {...liProps} {...props}>{liProps.children}</FadeInElement>;
          }
